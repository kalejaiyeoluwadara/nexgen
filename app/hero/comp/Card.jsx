...
function Card({ title, sub, img, route, desc }) {
  return (
    <Link href={`/courses/${route}`}>
      <div className="h-[464px] relative border-[1px] cursor-pointer hover:border-gray-600 transition-all border-gray-300 flex-shrink-0   rounded-[30px] p-4  ">
        <div className="relative">
          <Image
            className="h-[196px] object-cover w-full rounded-[28px] "
            src={img}
            alt=""
          />
        </div>
